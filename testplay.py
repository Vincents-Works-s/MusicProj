...
media = vlc.Media("Martin Garrix - Animals (Original Mix).mp3")
...
media2 = vlc.Media('Tremor (Sensation 2014 Anthem).mp3')
player2.set_media(media2)
player2.audio_set_volume(0)
player2.play()
print(player.audio_get_volume(), player2.audio_get_volume())
